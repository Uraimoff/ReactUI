      ...
      <table className="min-w-full bg-defaultLightBg dark:bg-defaultDarkBg">
        ...
        <tbody>
          {data[language].map((item, index) => (
            ...
            >
              <td className="border-b p-4 font-mono">{item.property}</td>
              <td className="border-b p-4">{item.description}</td>
              <td className="border-b p-4 font-mono text-pink-500">
                {item.type}
              </td>
              <td className="border-b p-4">{item.default}</td>
              <td className="border-b p-4">{item.version || "-"}</td>
            </tr>
          ))}
        </tbody>
      </table>
